  ...
  return (
    <div className="rounded-2xl border border-[#E2E8F0] overflow-hidden bg-white">
      <Table>
        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.club} className="border-b border-[#F1F5F9]" style={{ background: row.pos === 1 ? "#EEF3FF" : "white" }}>
              ...
              <TableCell>
                <div className="flex items-center gap-3">
                  ...
                  {row.pos <= promotionSpots && <Badge variant="promotion" className="text-[9px] px-1.5 py-0">Promo</Badge>}
                </div>
              </TableCell>
