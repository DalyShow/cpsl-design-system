        ...
        {items.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href}
              ...
              style={{ background: active ? "#0047FF" : "transparent", color: active ? "white" : "#94A3B8" }}>
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 flex flex-col overflow-y-auto z-50"
      ...
      <div className="p-5 border-b" style={{ borderColor: "#1E2D45" }}>
        <div className="flex items-center gap-3 mb-2">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "#0047FF" }}>
          ...
          <div>
            <div className="text-xs font-bold tracking-widest uppercase" style={{ color: "#0047FF" }}>CPSL</div>
        ...
        <span className="text-xs font-semibold px-2 py-0.5 rounded-full inline-block"
          style={{ background: "#0047FF22", color: "#7C9DFF", border: "1px solid #0047FF44" }}>
          v1.0
        </span>
      </div>
