...
const STATE_TOKENS = {
  primary: {
    default:  { bg: "#0047FF",                color: "#ffffff", border: "none",              ring: "none" },
    hover:    { bg: "rgba(0,71,255,0.88)",     color: "#ffffff", border: "none",              ring: "none" },
    focus:    { bg: "#0047FF",                color: "#ffffff", border: "none",              ring: "0 0 0 3px rgba(0,71,255,0.5)" },
    active:   { bg: "rgba(0,71,255,0.82)",     color: "#ffffff", border: "none",              ring: "none" },
    disabled: { bg: "#0047FF",                color: "#ffffff", border: "none",              ring: "none", opacity: 0.5 },
  },
  orange: {
    default:  { bg: "#FF5A1F",                color: "#ffffff", border: "none",              ring: "none" },
    hover:    { bg: "rgba(255,90,31,0.88)",    color: "#ffffff", border: "none",              ring: "none" },
    focus:    { bg: "#FF5A1F",                color: "#ffffff", border: "none",              ring: "0 0 0 3px rgba(255,90,31,0.4)" },
    active:   { bg: "rgba(255,90,31,0.82)",    color: "#ffffff", border: "none",              ring: "none" },
    disabled: { bg: "#FF5A1F",                color: "#ffffff", border: "none",              ring: "none", opacity: 0.5 },
  },
  secondary: {
  ...
  outline: {
    ...
    hover:    { bg: "#FF5A1F",                color: "#ffffff", border: "1.5px solid #FF5A1F", ring: "none" },
    focus:    { bg: "#F4F6FA",                color: "#0A0E1A", border: "1.5px solid #E2E8F0", ring: "0 0 0 3px rgba(0,71,255,0.5)" },
    active:   { bg: "rgba(255,90,31,0.9)",     color: "#ffffff", border: "1.5px solid #FF5A1F", ring: "none" },
  ...
  ghost: {
    ...
    hover:    { bg: "#EEF1F7",                color: "#0A0E1A", border: "none",              ring: "none" },
    focus:    { bg: "transparent",            color: "#0A0E1A", border: "none",              ring: "0 0 0 3px rgba(0,71,255,0.5)" },
    active:   { bg: "rgba(238,241,247,0.8)",   color: "#0A0E1A", border: "none",              ring: "none" },
    disabled: { bg: "transparent",            color: "#0A0E1A", border: "none",              ring: "none", opacity: 0.5 },
  },
  destructive: {
...
const STATE_DESCRIPTIONS: Record<StateKey, string> = {
  ...
  focus:    "3px ring · ring-ring/50 · #0047FF at 50%.",
...
/* Default */
.btn-primary {
  background-color: var(--primary);          /* #0047FF */
      ...
      <div className="px-12 py-12">
        ...
        <Section title="Interaction States — Documented">
          <div className="rounded-2xl overflow-hidden border border-[#E2E8F0]">
            {/* Column headers */}
            <div className="grid bg-[#0A0E1A]" style={{ gridTemplateColumns: "180px repeat(5, 1fr)" }}>
          ...
          <div className="rounded-2xl border bg-white border-[#E2E8F0] p-8 flex gap-8 items-start">
            ...
            <div className="flex flex-col gap-4 shrink-0">
              ...
              <div className="flex gap-4 p-6 rounded-xl bg-[#F4F6FA] border border-[#E2E8F0]">
                <Button variant="default">Primary</Button>
                <Button variant="cpsl-orange">Orange</Button>
                <Button variant="outline">Outline</Button>
                <Button variant="ghost">Ghost</Button>
              </div>
            ...
            <div className="flex-1 flex flex-col gap-3">
              ...
              <div className="rounded-xl border border-[#E2E8F0] overflow-hidden">
                {[
                  ...
                  { property: "ring color", value: "#0047FF at 50% alpha", token: "ring-ring/50" },
            ...
            <div className="mt-6 pt-6 border-t border-[#F1F5F9]">
              ...
              <div className="flex gap-3 items-center">
                {(["icon-xs","icon-sm","icon","icon-lg"] as const).map((s, i) => (
                  <Button key={s} size={s} variant={i === 0 ? "outline" : i === 1 ? "secondary" : i === 2 ? "default" : "cpsl-orange"} aria-label="Navigate">
