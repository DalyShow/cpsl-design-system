...
const MATCHES = [
  // March 1
  { day: 1, kickoff: "12:00", status: "fulltime" as const, competition: "premiership", matchday: 22,
  ...
  { day: 1, kickoff: "14:00", status: "fulltime" as const, competition: "premiership", matchday: 22,
    home: { name: "Raleigh Athletic", position: 2, score: 2 },
    away: { name: "Triangle FC", position: 4, score: 2 },
    venue: "Dix Park Fields, Raleigh NC" },
  { day: 1, kickoff: "16:00", status: "fulltime" as const, competition: "premiership", matchday: 22,
  ...
  // March 7
  { day: 7, kickoff: "14:00", status: "upcoming" as const, competition: "premiership", matchday: 23,
    home: { name: "Durham United", position: 3 },
    away: { name: "Raleigh Athletic", position: 2 },
    venue: "Durham Soccer Complex, Durham NC" },
  { day: 7, kickoff: "16:00", status: "upcoming" as const, competition: "premiership", matchday: 23,
    home: { name: "Charlotte FC", position: 1 },
    away: { name: "Greensboro FC", position: 5 },
    venue: "Matthews Sportsplex, Charlotte NC" },
  // March 8
  { day: 8, kickoff: "15:00", status: "live" as const, competition: "premiership", matchday: 23, minute: 34,
    home: { name: "Triangle FC", position: 4, score: 1 },
    away: { name: "Winston-Salem SC", position: 6, score: 0 },
    venue: "WakeMed Soccer Park, Cary NC" },
  // March 14
  { day: 14, kickoff: "14:00", status: "upcoming" as const, competition: "premiership", matchday: 24,
    home: { name: "Charlotte FC", position: 1 },
    away: { name: "Triangle FC", position: 4 },
    venue: "Matthews Sportsplex, Charlotte NC" },
  { day: 14, kickoff: "16:00", status: "upcoming" as const, competition: "premiership", matchday: 24,
    home: { name: "Raleigh Athletic", position: 2 },
    away: { name: "Durham United", position: 3 },
    venue: "Dix Park Fields, Raleigh NC" },
  // March 21
  { day: 21, kickoff: "14:00", status: "upcoming" as const, competition: "premiership", matchday: 25,
      ...
      <div className="px-12 py-12">
        ...
        <Section title="2 — CalendarMatchCard — All States">
          ...
          >
            ...
            <CalendarMatchCard
              kickoff="14:00" status="upcoming" competition="premiership" matchday={23}
              home={{ name: "Charlotte FC", position: 1 }}
              away={{ name: "Durham United", position: 3 }}
              venue="Matthews Sportsplex, Charlotte NC"
            />
            ...
            <CalendarMatchCard
              kickoff="16:00" status="live" minute={34} competition="premiership" matchday={23}
              home={{ name: "Triangle FC", position: 4, score: 1 }}
              away={{ name: "Winston-Salem SC", position: 6, score: 0 }}
              venue="WakeMed Soccer Park, Cary NC"
            />
            ...
            <CalendarMatchCard
              kickoff="12:00" status="fulltime" competition="premiership" matchday={22}
              home={{ name: "Charlotte FC", position: 1, score: 3 }}
              away={{ name: "Durham United", position: 3, score: 1 }}
              venue="Matthews Sportsplex, Charlotte NC"
            />
            ...
            <CalendarMatchCard
              kickoff="13:00" status="postponed" competition="premiership" matchday={22}
              home={{ name: "Greensboro FC", position: 5 }}
              away={{ name: "Triangle FC", position: 4 }}
              venue="Bryan Park, Greensboro NC"
            />
