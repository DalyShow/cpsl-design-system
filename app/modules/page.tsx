...
const clubs: Club[] = [
  { abbr: "CFA", name: "Charlotte FC Academy", city: "Charlotte",      color: "#4A78E8", tier: "premier"  },
  { abbr: "RLH", name: "Raleigh Athletic",      city: "Raleigh",       color: "#8B40D4", tier: "premier"  },
...
const standingsRows: StandingRow[] = [
  { pos: 1, club: "Charlotte FC",     abbr: "CFA", color: "#4A78E8", p: 18, w: 14, d: 2,  l: 2,  gd: "+24", pts: 44, form: ["W","W","W","D","W"] },
  { pos: 2, club: "Raleigh Athletic", abbr: "RLH", color: "#8B40D4", p: 18, w: 11, d: 4,  l: 3,  gd: "+14", pts: 37, form: ["W","D","W","L","W"] },
  { pos: 3, club: "Durham United",    abbr: "DUR", color: "#0A0E1A", p: 18, w: 10, d: 3,  l: 5,  gd: "+8",  pts: 33, form: ["D","W","L","W","D"] },
...
const featureIcons = {
  clock: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4A78E8" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" /></svg>,
  users: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4A78E8" strokeWidth="2" strokeLinecap="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" /></svg>,
  chart: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4A78E8" strokeWidth="2" strokeLinecap="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12" /></svg>,
}
